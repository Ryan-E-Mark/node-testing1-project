...
describe('[Exercise 2] trimPropertiesMutation', () => {
  test('[3] returns an object with the properties trimmed', () => {
    const input = {name: '  Ryan  ', lastname: ' Mark   '}
    const trimmed = utils.trimPropertiesMutation(input)
    expect(trimmed).toEqual({name: 'Ryan', lastname: 'Mark'})
  })
...
describe('[Exercise 4] Counter', () => {
  ...
  test('[6] the FIRST CALL of counter.countDown returns the initial count', () => {
    counter.countDown()
    expect(counter.result).toEqual(3)
  })
  test('[7] the SECOND CALL of counter.countDown returns the initial count minus one', () => {
    counter.countDown()
    counter.countDown()
    expect(counter.result).toEqual(2)
  })
...
describe('[Exercise 6] Car', () => {
  ...
  test('[17] refueling allows to keep driving', () => {
    ...
    focus.drive(1)
    focus.refuel(99)
    expect(focus.canDrive).toEqual(600)
  })
